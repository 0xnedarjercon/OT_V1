...
interface IBorrowForSwapInterface extends ethers.utils.Interface {
  functions: {
...
export class IBorrowForSwap extends BaseContract {
  ...
  interface: IBorrowForSwapInterface;
  ...
  estimateGas: {
    getDebt(asset: string, overrides?: CallOverrides): Promise<BigNumber>;
